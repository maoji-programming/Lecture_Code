<!--
/////////////////////////////////////////////////////////////
/* aboutus.php from CSCI3100 group 15
   03-05-2019
        ...
        <div class="container ">
            <div class="text-center darken-grey-text mb-4">
                <p style="color: rgba(255,255,255,.9)">
                    <font face="Economica, sans-serif" size="7"><b>About us</b></font>
                </p>              
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-5 mx-auto">
                <img src="assets/images/logogr.png" alt="Logo" style="width:100%; margin-top: 20px">
            </div>
